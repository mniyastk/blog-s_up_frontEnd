          ...
          <div className="  shadow-md  sm:w-full sm:h-[70vh] 2xl:h-[80vh] hidden md:flex">
            <div className=" w-4/6   hidden md:block">
              ...
              >
                ...
                <p className=" sm:text-4xl hover:text-red-100 flex flex-col w-fit h-full justify-end  text-white relative z-10">
                  <Link to={`/home/blog/${topic?._id}`}>{topic?.title}</Link>
                </p>
              </div>
            </div>
