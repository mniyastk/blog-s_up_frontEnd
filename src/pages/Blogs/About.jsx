    ...
    <div className=" h-screen flex flex-col justify-between">
      ...
      <section class="container mx-auto mt-8 p-6 bg-white rounded-lg shadow-lg">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg mb-4">
            At Blog's Up, we believe in the power of words to inspire,
            inform, and connect people from all walks of life. Our mission is to
        ...
        <div className="mb-8">
          ...
          <ul className="list-disc pl-4">
            <li className="text-lg mb-2">
              <strong>Diverse Content:</strong> From technology to travel, from
              health to hobbies, we cover a wide range of topics to cater to
              every interest and curiosity.
            </li>
            <li className="text-lg mb-2">
              <strong>Expert Insights:</strong> Our team of experienced writers
              and contributors bring a wealth of knowledge and expertise to each
              article, ensuring that you receive accurate information and
              valuable insights.
            </li>
            <li className="text-lg mb-2">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg mb-4">
            At Blog's Up, we believe in the power of community. We
            encourage lively discussions, respectful debates, and the sharing of
            diverse perspectives. Join us in building a supportive and inclusive
        ...
        <div className="mb-8">
          ...
          <p className="text-lg mb-4">
            ...
            here to listen. Connect with us on social media, leave a comment on
            your favorite articles, or reach out via email. Together, let's
            continue to make Blog's Up a vibrant hub of ideas and
            inspiration.
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-lg mb-4">
            Don't miss out on the latest updates and articles from Blog's Up. Subscribe to our newsletter and follow us on social media to
      ...
      <footer class="bg-gray-800 text-white p-1 mt-8">
